            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-4">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <Link to="/projects" className="text-emerald-400 hover:text-emerald-300 flex items-center gap-2 group text-sm font-medium tracking-wide uppercase">
                            View All Projects
                        ...
                        {projects.slice(0, 4).map((project) => (
                            ...
                            >
                                ...
                                <div className="p-6 flex-1 flex flex-col">
                                    ...
                                    <Link to={`/projects/${project.slug}`} className="absolute inset-0 z-0" aria-label={`View ${project.title}`} />
